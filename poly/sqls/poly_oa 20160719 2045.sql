...
--
-- Definition of table `t_poly_contract_attachment`
--

DROP TABLE IF EXISTS `t_poly_contract_attachment`;
CREATE TABLE `t_poly_contract_attachment` (
...
--
-- Dumping data for table `t_poly_contract_attachment`
--

/*!40000 ALTER TABLE `t_poly_contract_attachment` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_poly_contract_attachment` ENABLE KEYS */;
